...
export function About() {
  return (
    <section id="about" className="section-shell relative -mt-4 pb-10 pt-6 md:-mt-10 md:pb-16 md:pt-12">
      ...
      <div className="section-container">
        ...
        <div className="mt-6 max-w-3xl space-y-6 sm:mt-10 sm:space-y-12">
            <Reveal delay={0.1}>
